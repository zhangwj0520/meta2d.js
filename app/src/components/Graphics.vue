...
:deep(.t-collapse .t-collapse-panel__content) {
...
:deep(.t-collapse .t-collapse-panel__content .graphic) {
  position: relative;
  padding: 10px 0;
  border-radius: 2px;
...
:deep(.t-collapse .t-collapse-panel__content .graphic:hover) {
  cursor: pointer;
  border-color: var(--color-primary);
}

:deep(.t-collapse .t-collapse-panel__content .graphic p) {
  margin-top: 6px;
  padding: 0 8px;
  text-align: center;
  font-size: 12px;
...
:deep(.t-collapse .t-collapse-panel__content .graphic svg) {
  color: var(--color);
  height: 28px;
  width: 100%;
  margin: auto;
